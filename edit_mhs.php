			...
			<h3 style="margin-top: 15px; color:black">Edit Data Mahasiswa</h3></center>
              ...
              if (isset($_POST['update'])) {
                if (isset($_POST['nim']) && isset($_POST['namamhs']) && isset($_POST['jk']) && isset($_POST['alamat']) && isset($_POST['kota']) && isset($_POST['email']) && isset($_FILES['foto'])) {
                    ...
                    if($update){
                      echo "<script>alert('Okkeee.. Data Berhasil Diperbarui! :)) ');</script>";
                      echo "<script>window.location.href = 'home_mhs.php';</script>";
                    }else{
                      echo "<script>alert('Upsss.. Data Gagal Diperbarui! :(( ');</script>";
                      echo "<script>window.location.href = 'home_mhs.php';</script>";
                    }

                  }else{
                    echo "<script>alert('Data Kosong, isi dulu :) ');</script>";
                    header("Location: edit_mhs.php?id=$id");
                  }
                }
