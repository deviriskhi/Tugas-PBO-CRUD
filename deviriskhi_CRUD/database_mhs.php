...
class database{
    ...
    public function __construct()
    {
        try{
            ...
            echo "Error! No Connection" .$e->getMessage();
        }
    }
    ...
    public function insert(){
        if(isset($_POST['submit'])){
                    ...
                    if($sql = $this->konek->query($query)){
                        ...
                        echo "<script>alert('Sorry.. Data Gagal Tersimpan :(( ');</script>";
                        echo "<script>window.location.href = 'home_mhs.php';</script>";

                    }
                }else{
                        echo "<script>alert('Empty. Isi data dulu');</script>";
						echo "<script>window.location.href = 'home_mhs.php';</script>";
                }
            }
        }
